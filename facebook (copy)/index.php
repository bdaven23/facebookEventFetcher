...
echo "Access Token : ".$session['access_token']."<br/>";
        ...
        <?php if ($me): ?>
               <!-- <fb:serverFbml>
                ...
                <fb:fbml>
                    <fb:request-form
                        method='POST'
                        type='join my Event group'
                        content='Would you like to join my Event group?
                            <fb:req-choice url="http://apps.facebook.com/eventfetcher/yes.php"
                                label="Yes" />'
                            <fb:req-choice url="http://apps.facebook.com/eventfetcher/no.php"
                                label="No" />'
                        <fb:multi-friend-selector
                            actiontext="Invite your friends to join your Event group.">
                    </fb:request-form>
                </fb:fbml>
                </script>
                </fb:serverFbml>
